...
const AddEditUserModal = ({ isOpen, onClose, user, onSave }) => {
  ...
  const loadRoles = async () => {
    ...
    try {
      ...
      setErrors({ submit: 'Failed to load roles. Please refresh and try again.' });
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ 
        submit: error.message || error?.error || 'Failed to save user. Please try again.' 
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <Modal 
      ...
      subtitle={user ? 'Update user account information' : 'Create a new user account'}
      size="md"
    >
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              className={`w-full pl-10 pr-4 py-2.5 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-colors ${
        ...
        {/* <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-colors"
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleChange}
                className={`w-full px-4 py-2.5 pr-10 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-colors ${
        ...
        <div>
          ...
          {rolesLoading ? (
            ...
            <select
              ...
              onChange={handleChange}
              className={`w-full px-4 py-2.5 border rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:bg-white transition-colors appearance-none ${
          ...
          {roles.length === 0 && !rolesLoading && (
            <p className="mt-1.5 text-xs text-gray-500">No roles available. Please create a role first.</p>
          )}
        </div>
