...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              >
                <button className="group px-5 py-2.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl hover:shadow-lg hover:shadow-green-500/50 transition-all flex items-center gap-2">
                  <Building2 className="w-4 h-4" />
                  <span className="text-sm font-medium">Join as Agency</span>
                  <ChevronRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                </button>
                <button className="group px-5 py-2.5 bg-gradient-to-r from-orange-500 to-amber-500 text-white rounded-xl hover:shadow-lg hover:shadow-orange-500/50 transition-all flex items-center gap-2">
            ...
            >
              <div className="relative">
                ...
                <motion.div
                  ...
                  className="absolute top-1/2 -right-6 bg-white p-5 rounded-2xl shadow-2xl z-20 border border-green-100"
                >
                  <div className="flex items-center gap-3">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <motion.div
              variants={fadeInUp}
              whileHover={{ y: -10 }}
              className="relative p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-green-100 group overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-green-400/10 to-emerald-400/10 rounded-full blur-2xl group-hover:scale-150 transition-transform" />
              <div className="relative">
                <div className="w-16 h-16 bg-gradient-to-br from-green-600 to-emerald-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
                  <Building2 className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-2xl mb-4">For Agencies</h3>
                <div className="space-y-3 text-gray-600">
                  <div className="flex items-start gap-3">
                    <CircleDot className="w-5 h-5 text-green-500 flex-shrink-0 mt-0.5" />
            ...
            <motion.div
              ...
              className="relative p-8 bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all border border-orange-100 group overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br from-orange-400/10 to-amber-400/10 rounded-full blur-2xl group-hover:scale-150 transition-transform" />
              <div className="relative">
                <div className="w-16 h-16 bg-gradient-to-br from-orange-600 to-amber-500 rounded-2xl flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
          ...
          >
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-center gap-8">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="relative">
                  <div className="w-20 h-20 bg-gradient-to-br from-green-600 to-emerald-500 rounded-2xl flex items-center justify-center shadow-lg">
                    <Building2 className="w-8 h-8 text-white" />
                  </div>
                  <div className="absolute -bottom-2 -right-2 w-12 h-12 bg-gradient-to-br from-orange-600 to-amber-500 rounded-xl flex items-center justify-center shadow-lg border-2 border-white">
          ...
          >
            {touristFeatures.map((feature, index) => (
              <motion.div
                ...
                variants={fadeInUp}
                whileHover={{ y: -8 }}
                className="group p-8 bg-gradient-to-br from-white to-gray-50 rounded-3xl shadow-lg hover:shadow-2xl transition-all border border-gray-100"
              >
                <div
      ...
      <section
        id="for-agencies"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-green-50 via-white to-emerald-50"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="hidden"
          ...
          >
            {agencyFeatures.map((feature, index) => (
              ...
              >
                <div className="w-12 h-12 bg-gradient-to-br from-green-600 to-emerald-500 rounded-xl flex items-center justify-center mb-4 shadow-md group-hover:scale-110 transition-transform">
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <button className="group px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-500 text-white rounded-2xl hover:shadow-lg hover:shadow-green-500/50 transition-all flex items-center gap-2">
                Join as Agency
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </div>
      ...
      <section
        id="for-guides"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-50 via-white to-amber-50"
      >
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial="hidden"
          ...
          >
            {guideFeatures.map((feature, index) => (
              ...
              >
                <div className="w-14 h-14 bg-gradient-to-br from-orange-600 to-amber-500 rounded-2xl flex items-center justify-center mb-6 shadow-md group-hover:scale-110 transition-transform">
                  <feature.icon className="w-7 h-7 text-white" />
                </div>
                <h3 className="text-xl mb-3">{feature.title}</h3>
                <p className="text-gray-600">{feature.description}</p>
          ...
          >
            <div className="space-y-6 order-2 md:order-1">
              ...
              <div className="p-6 bg-gradient-to-br from-orange-100 to-amber-100 rounded-2xl border border-orange-200">
              ...
              <button className="group px-8 py-4 bg-gradient-to-r from-orange-600 to-amber-500 text-white rounded-2xl hover:shadow-lg hover:shadow-orange-500/50 transition-all flex items-center gap-2">
                Become a Guide
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-600 via-emerald-500 to-orange-600 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          >
            ...
            >
              <button className="group px-6 py-3 bg-white/10 backdrop-blur-sm text-white rounded-xl border border-white/30 hover:bg-white/20 transition-all flex items-center gap-2">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                />
                <div>
                  <span className="text-xl text-white font-bold">SwifTrip</span>
                  <div className="flex items-center gap-1">
            ...
            {/* For Users */}
            <div>
              <h4 className="text-white mb-4 font-semibold">For Users</h4>
              <ul className="space-y-2 text-sm">
                <li>
                  <a
                    href="#features"
            ...
            <div className="grid sm:grid-cols-3 gap-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-white">support@swiftrip.pk</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-white">+92 XXX XXXXXXX</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-gray-800 rounded-xl flex items-center justify-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-white">Islamabad, Pakistan</div>
                </div>
              </div>
            </div>
          </div>
